...
// Setup logging
const log = {
    debug: (...args: any[]) => isDev && console.debug("[DemoDojo:Recording]", ...args),
    info: (...args: any[]) => isDev && console.info("[DemoDojo:Recording]", ...args),
    warn: (...args: any[]) => isDev && console.warn("[DemoDojo:Recording]", ...args),
    error: (...args: any[]) => isDev && console.error("[DemoDojo:Recording]", ...args)
}
